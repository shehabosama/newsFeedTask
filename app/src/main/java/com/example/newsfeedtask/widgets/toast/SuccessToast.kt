...
private constructor(context: Activity) : Toast(context) {
    ...
    private fun setMessage(context: Activity, @StringRes resId: Int) {
        @SuppressLint("InflateParams") val view: View =
            context.layoutInflater.inflate(R.layout.toast_success, null)
    ...
    companion object {
         ...
         * @param resId   The resource id of the string resource to use.
         */
        fun makeText(context: Activity, @StringRes resId: Int): SuccessToast {
            val toast = SuccessToast(context)
         ...
         * @param message The text to show.
         */
        fun makeText(context: Activity, message: String): SuccessToast {
            val toast = SuccessToast(context)
         ...
         * @param resId   The resource id of the string resource to use.
         */
        fun makeShortText(context: Activity, @StringRes resId: Int): SuccessToast {
            val toast = SuccessToast(context)
            toast.setMessage(context, resId)
         ...
         * @param message The text to show.
         */
        fun makeShortText(context: Activity, message: String): SuccessToast {
            val toast = SuccessToast(context)
            toast.setMessage(context, message)
            toast.duration = LENGTH_SHORT
            toast.setGravity(Gravity.CENTER, 0, 0)
